...
export default function Hero() {
  return (
      <section
        ...
        className="h-[101svh] flex flex-col gap-1 items-center justify-center snap-start  lg:px-8 px-4 font-[michroma]"
      >
        <div className="relative flex flex-col items-center justify-center mt-2">
          ...
          <h1 className="text-sm font-semibold text-white py-3 text-center lg:text-start">
            Design eye-catching social media banners in minutes with our
            intuitive generator
          </h1>
        ...
        <div className="py-8  items-center gap-6 justify-center lg:justify-start">
          {/* preview */}
          <div className="w-full bg-transparent backdrop-blur-3xl rounded-md aspect-[820/310] border border-white/10 shadow-lg overflow-hidden">
